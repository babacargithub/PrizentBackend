<template>
    <div class="card">
        <div class="card-body row">
            <div class="card-header"><h4>Générer un lot de Badges</h4></div>
            ...
            <form  @submit.prevent="submitRequest">
                <div class="form-group col-sm-12 required" element="div" bp-field-wrapper="true" bp-field-name="name"
                    ...
                    <input type="text" name="name"  class="form-control" v-model.number="quantity">
        ...
        <div class="card-body row">
            ...
            <form  @submit.prevent="getUnusedBadges(unUsedQuantity)">
                <div class="form-group col-sm-12 required" element="div" bp-field-wrapper="true" bp-field-name="name"
                    ...
                    <input type="text" name="name"  class="form-control" v-model.number="unUsedQuantity">
                    <input type="submit" value="Valider" class="btn btn-success"/>
                </div>
            </form>
            ...
            <div ref="images" class="q-gutter-lg">
                <template v-if="badges.length > 0">
                    <div :key="index" v-for="(badge,index) in badges" :ref="'qr_code_'+index" :id="'qr_code_'+index" class="q-card bg-primary row full-width  " style="height: 300px; border-radius: 2%">
                        <div class="col-12 text-center q-pt-lg"><span style="font-size: 20px; font-weight: bold; font-family: Helvetica,sans-serif" class="title-medium text-white">Badge Prizent</span></div>
...
export default {
    ...
    methods:{
        ...
        getUnusedBadges(quantity){
            ...
            Loading.show({message: "Chargement"})
            this.error = null
            window.axios.get("get_unused/"+quantity)
                .then(r => {
